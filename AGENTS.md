...
| URL canónica | https://cobros.smokecompany.shop |
...
5. Abrir **solo** https://cobros.smokecompany.shop
...
- Saltarse el purge si falla el alias, o borrar `localStorage` al limpiar caché

## Si el usuario ve versión vieja

1. URL = `cobros.smokecompany.shop`
